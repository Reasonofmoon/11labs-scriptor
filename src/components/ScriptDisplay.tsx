...
interface ScriptItemComponentProps {
  item: ScriptItem;
  isActive: boolean;
  isPast: boolean;
  mode: Mode;
...
const ScriptItemComponent = memo(forwardRef<HTMLDivElement, ScriptItemComponentProps>(
  ({ item, isActive, isPast, mode, index }, ref) => {
...
ScriptItemComponent.displayName = 'ScriptItemComponent';
