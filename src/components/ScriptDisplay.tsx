...
interface ScriptItemDisplayProps {
  item: ScriptItem;
  index: number;
  isActive: boolean;
  isPast: boolean;
...
const ScriptItemDisplay = memo(({ item, index, isActive, isPast, mode, registerRef }: ScriptItemDisplayProps) => {
...
ScriptItemDisplay.displayName = 'ScriptItemDisplay';
