...
// Optimization: Memoize list items to prevent re-rendering of all rows when currentIndex changes.
// Only the rows that change state (active/past) will re-render.
const ScriptItemRow = React.memo(({ item, index, isActive, isPast, mode, registerRef }: ScriptItemRowProps) => {
