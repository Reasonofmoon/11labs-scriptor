...
// Pre-defined heights for idle bars to prevent hydration mismatches
const IDLE_BAR_HEIGHTS = [12, 16, 14, 20, 18, 12, 16, 22];
...
const VisualizerComponent: React.FC<VisualizerProps> = ({ isPlaying, mode, analyser }) => {
  ...
  useEffect(() => {
    ...
    // Array index corresponds to frequency value (0-255)
