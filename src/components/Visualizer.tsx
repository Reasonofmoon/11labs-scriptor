...
export const Visualizer: React.FC<VisualizerProps> = ({ isPlaying, mode, analyser }) => {
  ...
  useEffect(() => {
    ...
    // Uint8Array values from Web Audio API are strictly 0-255.
    ...
    for (let val = 0; val <= 255; val++) {
      ...
      // Handle zero-height edge case for createLinearGradient
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        // Optimization: Stop rendering off-screen bars
