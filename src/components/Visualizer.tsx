...
const IDLE_BAR_HEIGHTS = [12, 16, 14, 20, 15, 18, 13, 17];
...
export const Visualizer: React.FC<VisualizerProps> = ({ isPlaying, mode, analyser }) => {
  ...
  useEffect(() => {
    ...
    // Cache gradients to avoid creating thousands of objects per second
    // Key is the byte value (0-255)
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        // Optimization: Stop drawing if outside canvas
