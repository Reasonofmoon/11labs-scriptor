...
// Deterministic idle heights to avoid hydration mismatches
...
export const Visualizer: React.FC<VisualizerProps> = React.memo(({ isPlaying, mode, analyser }) => {
  ...
  useEffect(() => {
    ...
    // Pre-calculate gradient cache to avoid creating objects in hot loop
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        ...
        // Use cached gradient or create and cache it
