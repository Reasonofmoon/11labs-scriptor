...
// Pre-defined heights to avoid hydration mismatch and unnecessary re-renders
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        ...
        // The barWidth calculation multiplies by 3, so typically ~2/3 of bars are off-screen.
        // This saves unnecessary gradient creation and fillRect calls.
