...
export const Visualizer: React.FC<VisualizerProps> = ({ isPlaying, mode, analyser }) => {
  ...
  useEffect(() => {
    ...
    // Pre-calculate gradients for all possible 256 byte values
  ...
  if (!isPlaying) {
    const idleHeights = [12, 18, 14, 22, 10, 20, 16, 24]; // Deterministic heights
    return (
