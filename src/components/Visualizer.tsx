...
export const Visualizer: React.FC<VisualizerProps> = ({ isPlaying, mode, analyser }) => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Pre-calculate all 256 possible gradients outside the render loop
    // This eliminates immense GC pressure from creating gradients on every frame
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        // ⚡ Bolt: Short-circuit break to avoid rendering off-screen elements
