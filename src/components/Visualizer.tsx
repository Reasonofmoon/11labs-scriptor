...
export const Visualizer = React.memo(function Visualizer({ isPlaying, mode, analyser }: VisualizerProps) {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Pre-calculate all possible gradients (0-255) outside the render loop
    // This avoids creating expensive CanvasGradient objects on every frame
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        // ⚡ Bolt: Early break if we are drawing outside the canvas
