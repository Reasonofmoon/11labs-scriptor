...
/**
 * ScriptItemRow is memoized to prevent unnecessary re-renders of the entire list.
 * Only the items whose status changes (active/past/future) will re-render when
 * the playback index updates, significantly improving performance for long scripts.
 */
export const ScriptItemRow = memo(forwardRef<HTMLDivElement, ScriptItemRowProps>(({
  item,
  index,
  mode,
  status
